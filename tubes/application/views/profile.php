...
<html lang="en" dir="ltr">
  <head>
    ...
    <style media="screen">
      ...
      .middle { border : solid 2px white; padding-top : 30px; padding-left : 30px; padding-right : 30px; padding-bottom : 10px;
        margin-left: 10%; width: 80%; height: 400px; background-color: white; }
  ...
  <body>
   ...
   <div class="middle">
     <div class="top">
       <div class="col-sm-3">
         <img src="<?php echo base_url();?>src/profile.png" style="width: 40px">
       </div>
       <div class="col-sm-9">
      ...
      <button type="button" class="btn btn-info btn-lg" action=" " style="font-size:12px; padding-left:9px;">Ubah Profil</button>
    </div>
    <div class="bottom">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Kembalikan buku?</h4>
                  </div>
